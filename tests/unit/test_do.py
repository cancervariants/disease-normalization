...
def do():
    ...
    class QueryGetter:
        ...
        def search(self, query_str):
            response = self.query_handler.search(query_str, keyed=True, incl="do")
...
def test_concept_id_match(
    do, neuroblastoma, pediatric_liposarcoma, richter, compare_records
):
...
def test_label_match(do, neuroblastoma, pediatric_liposarcoma, compare_records):
...
def test_xref_match(do, neuroblastoma, pediatric_liposarcoma, compare_records):
