...
def oncotree():
    ...
    class QueryGetter:
        ...
        def search(self, query_str):
            response = self.query_handler.search(query_str, keyed=True, incl="oncotree")
...
def test_concept_id_match(oncotree, neuroblastoma, nsclc, ipn, compare_records):
...
def test_associated_with_match(oncotree, neuroblastoma, nsclc, compare_records):
